...
If you do not have your own data, please download some from DANDI (alternatively, you can _stream_ the data from DANDI, although this will be very very slow). The notebook in this repo uses the data here: https://dandiarchive.org/dandiset/000939/0.260512.1701/files?location=sub-A3702 This is a 2 hour recording from a Cambridge Neurotech probe from Manchester's very own Adrian Duszkiewicz. It's quite big: 23GB! If you'd like to try a different type of data, maybe try:
...
You should see a successful message with no errors. If that works, you can run the workshop jupyter notebook by running
